...
switch ( $action )
{
    "en" {
        ...
        Write-Host "Encoding from input file '$inputFile.FullName' to output file '$outFileEncoded'."
    ...
    "de" {
        ...
        Write-Host "Decoding from input file '$inputFile.FullName' to output file '$outFileEncoded'."
